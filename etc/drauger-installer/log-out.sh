...
#  It's a universal log manager for drauger-installer to keep things consistent across all logs
...
LOG_LOCATION="/tmp/drauger-installer/log.txt"
...
log () {
	...
	if [[ ! -d "/tmp/drauger-installer" ]]; then
		mkdir "/tmp/drauger-installer"
	fi
